...
export function applyTheme(
	...
	element.style.setProperty(
		"--color-strong",
		colorToCSS(theme.colors.strong),
	);
	element.style.setProperty(
		"--color-accent",
		colorToCSS(theme.colors.accent),
	);
	element.style.setProperty(
		"--color-hover",
		colorToCSS(theme.colors.hover),
	);
	element.style.setProperty(
		"--color-active",
		colorToCSS(theme.colors.active),
	);

	// Background colors
	element.style.setProperty(
		"--color-bg-soft",
		colorToCSS(theme.colors.background.soft),
	);
	element.style.setProperty(
		"--color-bg-hard",
		colorToCSS(theme.colors.background.hard),
	);

	// Text colors
	element.style.setProperty(
		"--color-text-soft",
		colorToCSS(theme.colors.text.soft),
	);
	element.style.setProperty(
		"--color-text-hard",
		colorToCSS(theme.colors.text.hard),
	);
	element.style.setProperty(
		"--color-text-inverse",
		colorToCSS(theme.colors.text.inverse),
	);
